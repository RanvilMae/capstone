...
<div class="container max-w-md p-6 mx-auto bg-white rounded-lg shadow">
    <h2 class="mb-6 text-2xl font-bold">Add Market Price</h2>
    ...
    <form action="{{ route('admin.market-prices.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="source" class="w-full p-2 border rounded">
        </div>
        <button type="submit" class="px-4 py-2 text-white bg-green-600 rounded hover:bg-green-700">Add Price</button>
